...
plt.axvline(np.mean(coefs_posicion), color='r', label="Valor promedio montecarlo")
...
# esos cambios de # no estan reportados!
plt.axvline(np.mean(pendientes), color='r', label="Valor promedio montecarlo")
...
plt.plot(x, np.mean(pendientes) * x + np.mean(coefs_posicion), color='r', label="Ajuste lineal")
